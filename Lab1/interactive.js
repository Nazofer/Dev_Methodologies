...
const getParams = (str) => new Promise((input) => rl.question(str, input));

const validateInput = async () => {
  let a, b, c, isInvalid;
  do {
    a = +(await getParams('Введіть число a: '));
    b = +(await getParams('Введіть число b: '));
    c = +(await getParams('Введіть число c: '));
